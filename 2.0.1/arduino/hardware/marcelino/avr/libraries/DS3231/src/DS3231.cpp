...
uint8_t DS3231::second(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),SEC);
	return Math::dec(get(SEC));
}

uint8_t DS3231::minute(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),MIN);
	return Math::dec(get(MIN));
}

uint8_t DS3231::hour(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),HOUR);
	return Math::dec(get(HOUR));
}

uint8_t DS3231::week(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),WEEK);
	return Math::dec(get(WEEK));
}

uint8_t DS3231::day(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),DATE);
	return Math::dec(get(DATE));
}

uint8_t DS3231::month(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),MON);
	return Math::dec(get(MON));
}

uint8_t DS3231::year(uint8_t data) {
	if(data != 255)
		put(Math::bcd(data),YEAR);
	return Math::dec(get(YEAR));
}
