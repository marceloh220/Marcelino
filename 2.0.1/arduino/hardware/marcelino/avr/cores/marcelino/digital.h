...
public:
	...
	inline void port(sfr_type _port, uint8_t _data) { *_port = _data; }
	inline uint8_t port(sfr_type _port) { return *_port;	}
	inline void set(sfr_type _port, uint8_t _bit) { *_port|=(1<<_bit); }
	inline void clear(sfr_type _port, uint8_t _bit) { *_port&=~(1<<_bit); }
	inline void toggle(sfr_type _port, uint8_t _bit) { *_port^=(1<<_bit); }
	inline uint8_t ifset(sfr_type _port, uint8_t _bit) { return *_port&(1<<_bit); }
	inline uint8_t ifclear(sfr_type _port, uint8_t _bit) { return  !(*_port&(1<<_bit)); }
};
