...
typedef volatile Gpio_struct *		Gpio_type;
typedef volatile uint8_t *			sfr_type;

#define get_bit(P)			(uint8_t)pgm_read_byte(&digital_bit[P])
#define get_GPIO(P)			(Gpio_type)pgm_read_byte(&digital_GPIO[P])
#define get_PCMASK(P)		(sfr_type)pgm_read_byte(&digital_PCMASK[P])
#define get_PCMASK_vec(P)	(uint8_t)pgm_read_byte(&digital_PCMASK_vec[P])
